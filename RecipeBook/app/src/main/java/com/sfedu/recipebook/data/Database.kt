...
import com.sfedu.recipebook.data.daos.RecipeDao
import com.sfedu.recipebook.data.entities.Recipe
import com.sfedu.recipebook.data.entities.RecipeCategory
import com.sfedu.recipebook.data.entities.RecipeIngredient
import com.sfedu.recipebook.data.entities.RecipeStep
            ...
            return object : Callback() {
                override fun onCreate(db: SupportSQLiteDatabase) {
                    ...
                    Executors.newSingleThreadExecutor().execute {
                        ...
                        val recipes = listOf(
                            Recipe(
                                "Pancakes", "Easy", 30, 4,  RecipeCategory.Homepage, R.drawable.pancakes
                            ),
                            Recipe(
                                "Pasta", "Easy", 30, 4,  RecipeCategory.Homepage, R.drawable.pasta
                            ),
                            Recipe(
                                "Pizza", "Easy", 30, 4,  RecipeCategory.Homepage, R.drawable.pizza
                            )
                        )
        ...
        fun getDatabase(context: Context): AppDatabase {
            return INSTANCE ?: synchronized(this) {
                val instance = Room.databaseBuilder(
                    context.applicationContext, AppDatabase::class.java, "recipes"
